...
val sidTargetAbi = providers.gradleProperty("sidTargetAbi").orNull
...
android {
    ...
    defaultConfig {
        ...
        if (!sidTargetAbi.isNullOrBlank()) {
            ndk {
                abiFilters += sidTargetAbi
            }
        }
...
dependencies {
    ...
    implementation(files("libs/executorch-android-bpfree-1.2.0.aar"))
