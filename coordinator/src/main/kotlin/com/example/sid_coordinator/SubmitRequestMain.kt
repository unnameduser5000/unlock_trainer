...
fun main(args: Array<String>) {
    ...
    val beliefTransportMode = args.getOrNull(7)?.trim()?.lowercase()
        ?.takeIf { it.isNotEmpty() }
        ?: "terminal"
    require(beliefTransportMode in setOf("full", "terminal", "none")) {
        "Unsupported belief transport mode '$beliefTransportMode'."
    }
